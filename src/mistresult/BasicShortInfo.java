...
import static mistresult.PlainResultTable.DB_URL;

/**
 *
 * @author HP
 */
public class BasicShortInfo extends javax.swing.JPanel {

    /**
     * Creates new form BasicShortInfo
     */
    ...
    public BasicShortInfo() {
        initComponents();
        
    }
    void  showcgpa(String cgpa)
    {
        jLabel10.setText(cgpa);
    }
    public  void showinfo(String studentid) 
    {
        String sql = "select idnumber,firstname,middlename,lastname,batchnumber,email from students where studentid="+studentid;
        ...
        try {
            ...
            while(rs.next())
            {
                ...
                jLabel4.setText(rs.getString(2)+" "+rs.getString(3)+" "+rs.getString(4));
